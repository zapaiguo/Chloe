...
namespace Chloe.Entity
{
    public class EntityProperty
    {
        ...
        {
            PropertyDefinition definition = new PropertyDefinition(this.Property, new DbColumn(this.ColumnName, this.Property.PropertyType, this.DbType, null), this.IsPrimaryKey, this.IsAutoIncrement, this.SequenceName, this.Annotations);
            return definition;
        }
    }
}
