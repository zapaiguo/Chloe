...
namespace Chloe.Entity
{
    ...
    {
        public TypeDefinition(Type entityType, DbTable table, IList<PrimitivePropertyDefinition> properties, IList<object> annotations)
        {
        ...
        public ReadOnlyCollection<PrimitivePropertyDefinition> Properties { get; private set; }
