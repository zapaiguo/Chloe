...
namespace ChloeTest
{
    public class FeatureTest_MySql
    {
        static string ConnString = "Database='Chloe';Data Source=localhost;User ID=root;Password=sasa;CharSet=utf8;";
        static MySqlContext context = new MySqlContext(new MySqlConnectionFactory(ConnString));
        ...
        public static void PredicateTest()
        {
            ...
            ret = q.Select(a => new { Name = a.Name ?? "abc", Age = a.Age ?? 17, A = a.Age, B = (a.Age ?? 17) < 20 }).ToList();
        ...
        public static void CTest()
        {
            ...
            //var reader = context.Session.ExecuteReader("SELECT AVG(`Users`.`Age`) AS `C` FROM `Users` AS `Users`");
            var reader = context.Session.ExecuteReader("SELECT F_Decimal AS `C` FROM `TestEntity` AS `TestEntity`");
        ...
        public static void UpdateTest()
        {
            ...
            //r = context.Update<User>(a => new User() { Name = a.Name, Id = 1, Age = a.Age + 100, Gender = Gender.Man, OpTime = DateTime.Now }, a => a.Name == name);
