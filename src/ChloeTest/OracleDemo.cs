...
namespace ChloeTest
{
    public class OracleDemo
    {
        ...
        public static void Test()
        {
            ...
            //result = q.Where(a => a.OpTime != null).Select(a => a.OpTime.Value.AddHours(id)).ToList();

            result = q.Where(a => a.OpTime != null).Select(a => new { dt.Subtract(a.OpTime.Value).TotalDays }).ToList();
